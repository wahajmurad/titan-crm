...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ElementType }> = {
 DRAFT: { label: 'Draft', color: 'bg-gray-500/15 text-gray-500 border-gray-500/25', icon: FileEdit },
...
const TOP_STATS = [
 ...
 { key: 'pending', label: 'Pending', icon: Inbox, color: 'text-gray-500', bg: 'bg-gray-500/10' },
]
