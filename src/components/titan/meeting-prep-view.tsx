...
function BriefSectionCard({
  ...
  return (
    <motion.div variants={itemVariants} className="glass-card rounded-[18px] p-5">
...
function LoadingState() {
  return (
    ...
    >
      ...
      >
        <div className="w-20 h-20 rounded-2xl gradient-blue flex items-center justify-center shadow-lg shadow-blue-500/20">
...
function InputForm({
  ...
  return (
    ...
    >
      <div className="glass-card rounded-[22px] p-6 max-w-xl w-full mx-4">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl gradient-blue flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/20">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            className="w-full h-11 rounded-[14px] text-[13px] font-medium gradient-blue text-white hover:shadow-lg hover:shadow-blue-500/25 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
          >
...
function BriefDisplay({
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="gradient-blue rounded-[18px] p-6 text-white"
      >
      ...
      >
        <Button
          ...
          className="h-10 rounded-[12px] text-[13px] font-medium gradient-blue text-white hover:shadow-lg hover:shadow-blue-500/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 gap-2"
        >
