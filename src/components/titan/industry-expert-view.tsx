  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6">
      ...
      <div className="relative mb-8">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20 animate-pulse">
...
function SectionCard({ section, defaultOpen }: { section: ReportSection; defaultOpen: boolean }) {
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <Card className={cn(
        'bg-white border border-gray-200/80 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200',
        'border-l-4',
        section.borderColor
      )}>
...
export function IndustryExpertView() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Card className="bg-white border border-gray-200/80 rounded-xl shadow-sm mb-6 shrink-0">
