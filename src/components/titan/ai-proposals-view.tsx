    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        <div className="relative">
          <div className="w-16 h-16 rounded-2xl gradient-blue animate-pulse opacity-40" />
    ...
    return (
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Bottom actions */}
          <motion.div
            className="glass-card rounded-[18px] p-4 flex items-center justify-center gap-3"
            {...staggerItem}
          >
            <Button
              onClick={handleRegenerate}
              disabled={generating}
              className="text-[13px] rounded-[14px] gradient-blue text-white border-0 hover:opacity-90"
            >
        ...
        <div className="glass-card rounded-[22px] p-6">
          ...
          <motion.div className="mt-6" {...staggerItem}>
            <Button
              ...
              className="w-full h-11 rounded-[14px] gradient-blue text-white border-0 text-[13px] font-semibold hover:opacity-90 disabled:opacity-50 transition-opacity"
            >
