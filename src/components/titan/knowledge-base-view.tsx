...
function SkeletonCard() {
 return (
  <Card className="bg-white rounded-xl border border-gray-200/60 border-gray-200/60 dark:border-gray-700/40 overflow-hidden">
...
export function KnowledgeBaseView() {
 ...
 className="bg-white rounded-xl border border-gray-200/60 border-gray-200/60 dark:border-gray-700/40 rounded-[18px]"
    >
     ...
     {filtered.map((item) => {
      ...
      return (
       <motion.div key={item.id} variants={itemVariants}>
        <Card
 className="bg-white rounded-xl border border-gray-200/60 border-gray-200/60 dark:border-gray-700/40 overflow-hidden cursor-pointer group"
