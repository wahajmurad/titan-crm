  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 space-y-6">
      ...
      <div className="h-6 flex items-center">
        <p className="text-sm font-medium bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent transition-all duration-500">
...
export function StrategyAssistantView() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      {/* Empty state */}
      {!result && !isAnalyzing && (
        <div className="bg-white/80 backdrop-blur-xl border border-gray-200/60 rounded-xl p-12 shadow-sm text-center">
